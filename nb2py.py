...
PROJ_DIR = "Learn-Hands-On-Data-Structures-Algorithms-Python"
##################################################################################################
...
# HELPER FUNCTION
# ---------------
def convert_ipynb_to_py(notebook_path, module_path, options):
    """Convert a .ipynb file to .py"""

    exporter_configs = {"TemplateExporter": {"exclude_markdown": not options["keepmd"]}}
